...
import (
	...
	proto "github.com/chriswilliams1977/grpc-web/src/emoji/pb"
...
func (s *server) Emojize(c context.Context, res *proto.EmojizeRequest) (*proto.EmojizeReply, error) {
	//create a reply (response)
	return &proto.EmojizeReply{
		EmojizedText: emoji.Sprint(res.Text),
	}, nil
}
